...
var _cars = require("../../../../cars/infra/typeorm/entities/cars");
...
let Rental = exports.Rental = (_dec = (0, _typeorm.Entity)('rentals'), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _cars.Car), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'car_id'
